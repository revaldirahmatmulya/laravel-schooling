                            ...
                            <div class="col-md-12">
                                <div class="card">
                                    <div class="card-header card-info">
                                        <div class="card-title">Form Update Surat Keluar</div>
                                    </div>
                                    <div class="card-body">
                                        <form action="{{ route('arsip.surat.out.update',['mailOut' => $mailOut]) }}" method="POST"
                                            ...
                                            <div class="row">
                                                    ...
                                                    <div class="row">                                                        
                                                        ...
                                                        <div class="col">
                                                            ...
                                                            <label style="font-weight: 600">Berkas Lama</label><br>
                                                                <a href="{{ asset('storage/' . str_replace('public/','',$mailOut->file)) }}"
                                                ...
                                                <div class="form-group col-md-6">
                                                    <label for="receiver">Penerima (asal surat)</label>
                                                    <input type="text" class="form-control" id="receiver" name="receiver"
                                                        placeholder="PT. Sumber Makmur"
                                                        value="{{ old('receiver', $mailOut->receiver) }}">
                                                    @error('receiver')
                                                        <span class="text-danger">{{ $message }}</span>
                                                    @enderror
                                                </div>
                                                    ...
                                                    <select class="form-control" name="category" id="category"
                                                        ...
                                                        @foreach ($categories as $category)
                                                            <option value="{{ $category->id }}"
                                                                {{ old('category', $mailOut->mail_category_id) == $category->id ? 'selected' : '' }}>
