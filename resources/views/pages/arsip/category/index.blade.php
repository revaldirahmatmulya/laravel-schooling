                ...
                <div class="panel-header bg-primary-gradient">
                    <div class="page-inner py-5">
                        <div class="d-flex align-items-left align-items-md-center flex-column flex-md-row">
                            <div>
                                <h2 class="text-white pb-2 fw-bold">Kategori Surat</h2>
                            </div>
                            <div class="ml-md-auto py-2 py-md-0">
                                <a href="{{ route('arsip.surat.category.add') }}" class="btn btn-secondary btn-round"><i class="fa fa-plus-circle mr-2" aria-hidden="true"></i>Tambah Kategori Surat</a>
                            </div>
                        </div>
                    </div>
                </div>
	...
	<script>
		...
		$(document).ready( function () {
			...
			buttons: [
				...
				ajax: {
					url : '{!! route('arsip.surat.category.data') !!}',
					type : 'POST',
					data: {_token:_token},
				},
				columns: [
