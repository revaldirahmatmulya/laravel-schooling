                            ...
                            <div class="col-md-8">
                                <div class="card">
                                    <div class="card-header card-info">
                                        <div class="card-title">Form update pengadaan</div>
                                    </div>
                                    <div class="card-body">
                                        <form action="{{ route('sarpras.procurement.update',['procurement' => $procurement]) }}" method="POST"
                                            ...
                                            <div class="row">
                                                <div class="form-group col-md-12">
                                                    ...
                                                    <select class="col form-control pl-2" name="item" id="item">
                                                        <option value="">- Pilih Barang -</option>
                                                        @foreach ($items as $item)
                                                            <option value="{{ $item->id }}"
                                                                {{ old('item', $procurement->item_id) == $item->id ? 'selected' : '' }}>
                                                                {{ $item->name }}</option>
                                                        @endforeach
                                                    </select>
                                                    @error('item')
                                                ...
                                                <div class="form-group col-md-12">
                                                    ...
                                                    <select class="col form-control pl-2" name="supplier" id="supplier">
                                                        <option value="">- Pilih Supplier -</option>
                                                        @foreach ($suppliers as $supplier)
                                                            <option value="{{ $supplier->id }}"
                                                                {{ old('supplier', $procurement->supplier_id) == $supplier->id ? 'selected' : '' }}>
                                                ...
                                                <div class="form-group col-md-6">
                                                    ...
                                                    <input type="number" class="form-control" min="0" id="amount"
                                                        ...
                                                        value="{{ old('amount', $procurement->amount) }}">
                                                    @error('amount')
                                                        <span class="text-danger">{{ $message }}</span>
                                                    @enderror
                                                </div>
                                                <div class="form-group col-md-6">
                                                    ...
                                                    <div class="input-group">
                                                        ...
                                                        <input type="number" min="0" step="100"
                                                            ...
                                                            placeholder="Harga Barang" value="{{ old('price', $procurement->price) }}">
                                                    </div>
                                                    @error('price')
                                                        <span class="text-danger">{{ $message }}</span>
                                                    @enderror
                                                ...
                                                <div class="form-group col-md-12">
                                                    ...
                                                    <textarea name="description" id="description" class="form-control" rows="5"
                                                        placeholder="Deskripsi Barang / Alasan">{{ old('description', $procurement->description) }}</textarea>
                                                    @error('description')
                                                        <span class="text-danger">{{ $message }}</span>
                                                    @enderror
                                                </div>
                                            ...
                                            <div class="form-group">
                                                <button class="btn btn-primary btn-rounded">Perbarui pengadaan</button>
