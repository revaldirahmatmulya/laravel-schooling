                    ...
                    <div class="page-inner py-5">
                        <div class="d-flex align-items-left align-items-md-center flex-column flex-md-row">
                            ...
                            <div class="ml-md-auto py-2 py-md-0">
                                <a href="{{ route('sarpras.item.in.add') }}" class="btn btn-secondary btn-round"><i class="fa fa-plus-circle mr-2" aria-hidden="true"></i>Tambah Barang Masuk</a>
                            </div>
                        </div>
                    </div>
                </div>
	...
	<script>
		...
		$(document).ready( function () {
			...
			table =  $('#basic-datatables').DataTable({
				...
				ajax: {
					url : '{!! route('sarpras.item.in.data') !!}',
					type : 'POST',
					data: {_token:_token},
				},
				columns: [
