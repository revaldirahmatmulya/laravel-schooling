                        ...
                        <div class="row">
                            <div class="col-md-8">
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <form action="{{ route('sarpras.item.in.update', ['itemIn' => $itemIn->id]) }}"
                                            method="post">
                                            @csrf
                                            @method('put')
                                            <div class="form-group">
                                                ...
                                                <select class="form-control" name="item" id="item"
                                                    style="width: 100%" value="{{ old('item') }}" disabled>
                                                    <option value="">- Pilih Barang -</option>
                                                    @foreach ($items as $item)
                                                        <option value="{{ $item->id }}"
                                                            {{ old('item', $itemIn->item_id) == $item->id ? 'selected' : '' }}>
                                                            {{ $item->name }}</option>
                                                    @endforeach
                                                </select>
                                                @error('item')
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="number" class="form-control" id="amount" name="amount"
                                                    ...
                                                    value="{{ old('amount', $itemIn->amount) }}">
                                                @error('amount')
                                                    <span class="text-danger">{{ $message }}</span>
                                                @enderror
                                            </div>
                                            <div class="form-row mx-2">
                                                <div class="form-group col-md-6">
                                                    ...
                                                    <div class="input-group">
                                                        ...
                                                        <input type="number"
                                                            class="form-control" id="price" name="price" min="0" step="100"
                                                            placeholder="Harga Barang" value="{{ $itemIn->price }}">
                                                    </div>
                                                    @error('price')
                                                        <span class="text-danger">{{ $message }}</span>
                                                    @enderror
                                                ...
                                                <div class="form-group col-md-6">
                                                    ...
                                                    <input type="date" class="form-control" id="date_in" name="date_in"
                                                        ...
                                                        value="{{ old('date_in', date('Y-m-d', strtotime($itemIn->date))) }}">
                                                    @error('date_in')
                                                        <span class="text-danger">{{ $message }}</span>
                                                    @enderror
                                                </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" id="funds" name="funds"
                                                    placeholder="Sumber Dana" value="{{ old('funds', $itemIn->funds) }}">
                                                @error('funds')
                                                    <span class="text-danger">{{ $message }}</span>
                                                @enderror
                                            </div>
                                            <div class="form-group">
                                                ...
                                                <textarea type="text" class="form-control" id="description" rows="3" name="description"
                                                    placeholder="Jumlah Barang">{{ old('description', $itemIn->description) }}</textarea>
                                                @error('description')
                                                    <span class="text-danger">{{ $message }}</span>
                                                @enderror
                                            </div>
                                            <button class="btn btn-primary btn-rounded mt-2" type="submit">Update barang
                                                Masuk </button>
