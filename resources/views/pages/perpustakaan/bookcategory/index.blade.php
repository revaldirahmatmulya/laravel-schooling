                ...
                <div class="panel-header bg-primary-gradient">
                    <div class="page-inner py-5">
                        <div class="d-flex align-items-left align-items-md-center flex-column flex-md-row">
                            <div>
                                <h2 class="text-white pb-2 fw-bold">Kategori Buku</h2>
                                <h5 class="text-white op-7 mb-2">Kelola kategori buku</h5>
                            </div>
                            <div class="ml-md-auto py-2 py-md-0">
                                <a href="{{ route('perpustakaan.category.add') }}"
	...
	<script>
		...
		$(document).ready( function () {
			...
			buttons: [
				...
				ajax: {
					url : '{!! route('perpustakaan.category.data') !!}',
					type : 'POST',
					data: {_token:_token},
				},
				columns: [
