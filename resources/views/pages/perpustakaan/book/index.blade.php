                    ...
                    <div class="page-inner py-5">
                        <div class="d-flex align-items-left align-items-md-center flex-column flex-md-row">
                            <div>
                                ...
                                <h5 class="text-white op-7 mb-2">Kelola Data Buku</h5>
                            </div>
                            <div class="ml-md-auto py-2 py-md-0">
                                <a href="{{ route('perpustakaan.book.add') }}" class="btn btn-secondary btn-round"><i
                                        class="fa fa-plus-circle mr-2" aria-hidden="true"></i>Tambah Data Buku</a>
                            </div>
                        </div>
                    </div>
                </div>
	...
	<script>
		...
		$(document).ready( function () {
			...
			buttons: [
				...
				ajax: {
					url : '{!! route('perpustakaan.book.data') !!}',
					type : 'POST',
					data: {_token:_token},
				},
				columns: [
