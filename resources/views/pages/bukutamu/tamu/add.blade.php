							...
							<div class="card">
                                ...
                                <form action="{{ route('tamu.store') }}" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="name" name="name" placeholder="Nama Tamu" value="{{ old('name') }}">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="date" class="form-control" id="date" name="date" placeholder="telepon" value="{{ old('date') }}">
                                        @error('date') <span class="text-danger">{{ $message }}</span> @enderror
                                    </div>
                                    <div class="form-group">
                                        <label for="instance">Instansi</label>
                                        <input type="text" class="form-control" id="instance" name="instance" placeholder="Instansi" value="{{ old('instance') }}">
                                        @error('instance') <span class="text-danger">{{ $message }}</span> @enderror
                                    </div>
                                    <div class="form-group">
                                        <label for="necessary">Keperluan</label>
                                        <textarea name="necessary" class="form-control" id="necessary" rows="4">{{ old('necessary') }}</textarea>
                                        @error('necessary') <span class="text-danger">{{ $message }}</span> @enderror
                                    </div>
                                    <div class="form-group">
                                        <button class="btn btn-primary btn-rounded">Tambah Tamu</button>
