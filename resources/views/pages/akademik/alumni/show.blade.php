                                    ...
                                    <div class="card-body pl-4">
                                        <form action="#" method="POST" enctype="multipart/form-data">
                                            <div class="row">
                                                ...
                                                <div class="form-group col-md-6">
                                                    <label for="class">Nama Orang Tua</label>
                                                    <p style="color: slategrey">{{ $student->parent->user->name }}</p>
                                                </div>
                                                <div class="form-group col-md-6">
                                                ...
                                                <div class="form-group col-md-6">
                                                    ...
                                                    <p style="color: slategrey">{{ ($student->alumni)? 'Sudah alumni' : 'Belum lulus' }}</p>
                                                </div>
                                            ...
                                            <div class="mt-2 float-right">
                                                <a type="button" href="{{ route('akademik.users.alumni.index') }}"
