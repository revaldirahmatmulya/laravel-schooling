                        ...
                        <div class="row">
                            <div class="col-md-8">
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <form
                                            action="{{ route('akademik.setting.class.update', ['class' => $kelas->code, 'settingClass' => $settingClass->id]) }}"
                                            ...
                                            <div class="row">
                                                <div class="form-group col-md-7">
                                                    ...
                                                    <select class="form-control" name="day" id="day"
                                                        ...
                                                        <option value="senin"
                                                            {{ $settingClass->day == 'Senin' ? 'selected' : '' }}>Senin
                                                        </option>
                                                        <option value="selasa"
                                                            {{ $settingClass->day == 'Selasa' ? 'selected' : '' }}>Selasa
                                                        </option>
                                                        <option value="rabu"
                                                            {{ $settingClass->day == 'Rabu' ? 'selected' : '' }}>Rabu
                                                        </option>
                                                        <option value="kamis"
                                                            {{ $settingClass->day == 'Kamis' ? 'selected' : '' }}>Kamis
                                                        </option>
                                                        <option value="jumat"
                                                            {{ $settingClass->day == 'Jumat' ? 'selected' : '' }}>Jumat
                                                        </option>
                                                    </select>
                                                </div>
                                                <div class="form-group col-md-6">
                                                    ...
                                                    <input type="time" class="form-control" name="start_time"
                                                        id="start-time"
                                                        value="{{ old('start_time', $settingClass->start_time) }}">
                                                </div>
                                                <div class="form-group col-md-6">
                                                    <label for="end-time">Jam selesai</label>
                                                    <input type="time" class="form-control" name="end_time"
                                                        id="end-time"
                                                        value="{{ old('end_time', $settingClass->end_time) }}">
                                                </div>
                                                    ...
                                                    <select class="form-control" name="pelajaran" id="pelajaran"
                                                        ...
                                                        @foreach ($subjects as $subject)
                                                            <option value="{{ $subject->id }}"
                                                                {{ old('pelajaran', $settingClass->subject_id) == $subject->id ? 'selected' : '' }}>
                                                                {{ $subject->name }}</option>
                                                        @endforeach
                                                    ...
                                                    <select class="form-control" name="pengajar" id="pengajar"
                                                        ...
                                                        @foreach ($teachers as $teacher)
                                                            <option value="{{ $teacher->id }}"
                                                                {{ old('pengajar', $settingClass->teacher_id) == $teacher->id ? 'selected' : '' }}>
