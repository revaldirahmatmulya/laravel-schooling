                    ...
                    <div class="panel-header bg-primary-gradient">
                        <div class="page-inner py-5">
                            <div class="d-flex align-items-left align-items-md-center flex-column flex-md-row">
                                <div>
                                    <h2 class="text-white pb-2 fw-bold">Setting Kelas
                                        {{ $kelas->name . ' ' . $kelas->major->code }} </h2>
                                    <h5 class="text-white op-7 mb-2">Kelola informasi Kelas
                                        {{ $kelas->name . ' ' . $kelas->major->code }}.</h5>
                                </div>
                                <div class="ml-md-auto py-2 py-md-0">
                                    <a href="{{ route('akademik.setting.class.add', ['class' => $kelas->code]) }}"
                                        class="btn btn-secondary btn-round"><i class="fa fa-plus-circle mr-2"
                                            aria-hidden="true"></i>Tambah Pelajaran</a>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <div class="card">
                                    <div class="card-body">
                                        <form
                                            action="{{ route('akademik.setting.class.update.homeroom', ['class' => $kelas->code]) }}"
                                            ...
                                            <div class="form-group col-md-12">
                                                ...
                                                <select class="form-control" name="wali_kelas" id="wali_kelas"
                                                    style="width: 100%" value="{{ old('wali_kelas') }}">
                                                    <option value="">- PILIH -</option>
                                                    @foreach ($teachers as $teacher)
                                                        <option value="{{ $teacher->id }}"
                                                            {{ old('wali_kelas', $kelas->teacher_id) == $teacher->id ? 'selected' : '' }}>
