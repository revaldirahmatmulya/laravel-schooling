                    ...
                    <div class="page-inner py-5">
                        <div class="d-flex align-items-left align-items-md-center flex-column flex-md-row">
                            ...
                            <div class="ml-md-auto py-2 py-md-0">
                                <a href="{{ route('akademik.users.student.add') }}" class="btn btn-secondary btn-round"><i class="fa fa-plus-circle mr-2" aria-hidden="true"></i>Tambah Siswa</a>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <script>
				...
				columns: [
					...
					},
					{
						...
						render: function(data, type, row){
							...
							var url_detail = "{{ \Request::url() }}/"+row['nis'];
							return '\
		...
		function set_switch(id,isactive){
			$.ajax({
				...
				url: '{!! route('akademik.users.student.switch') !!}',
				dataType: 'JSON',
