                    ...
                    <div class="row">
                        <div class="col-md-8">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <form
                                        action="{{ route('master.users.teacher.update', ['teacher' => $teacher->id])}}"
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="form-group col-md-6">
                                                ...
                                                <input type="text" class="form-control" id="nip" name="NIP"
                                                    aria-describedby="nip" placeholder="nip"
                                            ...
                                            <div class="form-group col-md-6">
                                                ...
                                                <select class="form-control" name="gender" id="gender"
                                                    style="width: 100%" value="{{ old('gender') }}">
                                            ...
                                            <div class="form-group col-md-6">
                                                ...
                                                @error('birthplace') <span class="text-danger">{{ $message }}</span>
                                                @enderror
                                            </div>
                                            <div class="form-group col-md-6">
                                                ...
                                                @error('birthdate') <span class="text-danger">{{ $message }}</span>
                                                @enderror
                                            </div>
                                            <div class="form-group col-md-6">
                                            ...
                                            <div class="form-group col-md-6">
                                                ...
                                                <input type="text" class="form-control" id="phone" name="phone"
                                                    placeholder="Telepon" value="{{ old('phone', $teacher->phone) }}">
                                            ...
                                            <div class="form-group col-md-6">
                                                ...
                                                <select class="form-control" name="status" id="status"
                                                    ...
                                                    <option value="">- PILIH -</option>
                                                    <option value="1"
                                                        {{ old('status', $teacher->user->is_active) == '1' ? 'selected' : '' }}>
                                                        Aktif</option>
                                                    <option value="0"
                                                        {{ old('status', $teacher->user->is_active) == '0' ? 'selected' : '' }}>
                                                        Non Aktif</option>
                                            ...
                                            <div class="form-group col-md-12">
                                                ...
                                                <textarea name="address" id="address" class="form-control"
                                                    rows="5">{{ old('address', $teacher->address) }}</textarea>
                                        ...
                                        <div class="mt-2 float-right">
                                            <a type="button" href="{{ route('master.users.teacher.index') }}"
                                                class="btn btn-warning btn-rounded ml-2">Kembali</a>
                                            <button type="submit" class="btn btn-primary btn-rounded ml-2 ">Edit
                                                admin</button>
                                        </div>
                                    </form>
                                </div>
