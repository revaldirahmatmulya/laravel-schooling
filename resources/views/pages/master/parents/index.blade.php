                    ...
                    <div class="panel-header bg-primary-gradient">
                        <div class="page-inner py-5">
                            <div class="d-flex align-items-left align-items-md-center flex-column flex-md-row">
                                <div>
                                    <h2 class="text-white pb-2 fw-bold">Orang Tua Siswa </h2>
                                    <h5 class="text-white op-7 mb-2">Kelola informasi Orang Tua Siswa.</h5>
                                </div>
                                <div class="ml-md-auto py-2 py-md-0">
                                    <a href="{{ route('master.users.parents.add') }}" class="btn btn-secondary btn-round"><i
                                            class="fa fa-plus-circle mr-2" aria-hidden="true"></i>Tambah Orang Tua Siswa</a>
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    <script>
        ...
        $(document).ready(function() {
            table = $('#basic-datatables').DataTable({
                ...
                ajax: {
                    url: '{!! route('master.users.parents.data') !!}',
                    type: 'POST',
                    data: {
                        _token: _token
                    },
