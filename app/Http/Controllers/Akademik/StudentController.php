...
class StudentController extends Controller
{
    ...
    public function store(Request $request)
    {
        Validator::make(
            ...
            rules: [
                ...
                'email' => ['required', Rule::unique(User::class), 'max:200', 'email'],
                'gender' => ['required'],
                'class' => ['required'],
                'birthplace' => ['required'],
                'birthdate' => ['required'],
                ...
                'address' => ['required'],
                'status' => ['required'],
                'generation' => ['required', 'numeric','min:2000', 'max:'.(date('Y')+1)],
    ...
    {
        return view('pages.akademik.student.show', ['student' => $student]);
    }
