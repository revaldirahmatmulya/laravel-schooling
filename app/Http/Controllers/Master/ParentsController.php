...
class ParentsController extends Controller
{
    ...
    {
        return view('pages.master.parents.index');
    }

    public function data()
    {

        return DataTables::of(Parents::get()->load('user'))->make(true);
    }

    public function create()
    {

        return view('pages.master.parents.add', ['students' => Student::where('parent_id', null)->get()->load('user')]);
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->to(route('master.users.parents.index'));
    }
